---
title: "Symmetric Random Walk - 10 Independent Realizations with Reference Lines"
author: "Your Name"
date: "Today's Date"
output: html_document
---

```{r symmetric-random-walk-facet-with-lines, echo=TRUE, message=FALSE, warning=FALSE}
...
ggplot(random_walks, aes(x = Step, y = Position, color = Realization)) +
  geom_line(size = 1) +
